...
local function getCastInfo(unit, isChannel)
  if isChannel then
    ...
    local spellName, displayName, spellIcon, startTimeMS, endTimeMS, isTrade, _castId, uninterruptible = UnitCastingInfo(
    unit)
    return spellName, displayName, spellIcon, startTimeMS, endTimeMS, isTrade, uninterruptible
  end
end
...
function component:showCastbar(settings, isChannel)
  local unitId = settings.tag
  local spellName, displayName, spellIcon, startTimeMS, endTimeMS, _isTrade, uninterruptible = getCastInfo(unitId,
    isChannel)
